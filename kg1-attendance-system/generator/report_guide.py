...
GUIDE = [
    ...
    ("s", "2. في ورقة كل صف (KG1-A … KG1-E) اكتبي الأطفال مرة واحدة: الرقم الطلابي، اسم الطفل، الحالة الدراسية (نشط)، اسم ولي الأمر ورقم التواصل. لا تكرري الأسماء في أي ورقة أخرى."),
    ...
    ("s", "4. لإضافة صف جديد: أظهري إحدى الورقتين الاحتياطيتين (KG1-F أو KG1-G) عبر النقر بزر الفأرة الأيمن على أسماء الأوراق ← إظهار، ثم في «الإعدادات» غيّري «مفعّل» إلى نعم. لحذف صف: امسحي بياناته وأخفي الورقة وغيّري «مفعّل» إلى لا."),
