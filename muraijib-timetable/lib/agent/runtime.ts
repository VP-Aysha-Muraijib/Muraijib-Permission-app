  ...
  if (!teacherId) {
    return {
      ...
      needsClarificationAr:
        'لم أتعرّف على اسم المعلمة في طلبك. اكتب اسمها كما هو مسجّل في صفحة المعلمات، مثال: «انتقلت معلمة 3 من المدرسة، ما الحل؟».',
    };
  }
...
function handleLoadChange(
  ...
  if (!teacherId || target === undefined) {
    return {
      ...
      followUpsAr: [],
      needsClarificationAr:
        'حدّد اسم المعلمة والنصاب الجديد معًا، مثال: «غيّر نصاب معلمة 5 إلى 20».',
    };
  }
...
function handleLock(
  ...
  if (!teacherId && !sectionId) {
    return {
      ...
      facts: [],
      followUpsAr: [],
      needsClarificationAr: 'حدّد المعلمة أو الشعبة المراد تثبيت حصصها، مثال: «ثبّت حصص معلمة 2».',
    };
  }
...
function handleShowSchedule(
  ...
  if (!teacherId && !sectionId) {
    return {
      ...
      facts: [],
      followUpsAr: [],
      needsClarificationAr: 'حدّد المعلمة أو الشعبة، مثال: «اعرض جدول معلمة 4» أو «اعرض جدول الشعبة 6/2».',
    };
  }
...
function handleHelp(): Partial_ {
  return {
    ...
    facts: [],
    followUpsAr: [
      'انتقلت معلمة 3 من المدرسة، ما أثر ذلك على الجدول؟',
      'ابحث عن تعارضات',
