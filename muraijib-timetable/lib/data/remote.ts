 ...
 *
 * ⚠ الحالة: هذا الملف يوثّق عقد الواجهة مع الخادم، لكن مسارات /api لم تُنفَّذ بعد،
 * ولذلك يرفض getStore() تشغيل وضع supabase صراحةً بدل العمل نصف مربوط.
 * مخطط قاعدة البيانات وسياسات الأمان جاهزان ومتحقَّق منهما في مجلد supabase/.
 */
