 ...
 *
 * أمنيًا: القراءة تتم دائمًا بـ `{ header: 1 }` فتعود مصفوفات لا كائنات، فلا يتحوّل
 * أي عنوان عمود قادم من ملف المستخدم إلى مفتاح كائن. هذا يغلق مسار تلويث النموذج
 * الأولي في نسخة xlsx المتاحة على npm. لا تُغيَّر هذه الطريقة —
 * يحرسها tests/import-safety.test.ts. تفاصيل التنبيهات في README.
 */
